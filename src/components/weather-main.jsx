...
class WeatherMain extends React.Component {
  ...
  render() {
    const backgroundImgStyle = { 
      backgroundImage: `url(${require(`../assets/images/${this.state.currentCity === 'Belgrade' ? 'bg-2' : 'ns'}.jpg`)})`, 
      backgroundPosition: '2% top', 
      backgroundRepeat: 'no-repeat', 
      transition: 'background-image 0.6s ease-in' 
    };

    return <section className="main-container" style={backgroundImgStyle}>
        <div className="title-wrap">
          <div className="dropdown">
            ...
            <div className="dropdown-content" onClick={this.onCityChange.bind(this, this.props.dispatch)}>
